...
<%
    ...
    if (session.getAttribute("lista_tarea") == null) {
        ...
        Tarea t1 = new Tarea(1,"Inteligencia Artificial",true);
        Tarea t2 = new Tarea(2,"Desarrollo de Software ",true);
        Tarea t3 = new Tarea(3,"Defensa de proyecto de Prototipo de casa domótica ",false);
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2>Nombre : RICHARD ERICK HUAÑAPACO CHURA </h2>
